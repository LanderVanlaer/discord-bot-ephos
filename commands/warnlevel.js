...
module.exports.run = async (bot, message, args) => {
  ...
  message.reply(`<@${wUser.id}> has ${warnlevel.warns} warnings. The max of warns is ${botconfig.maxWarns}`);
}

module.exports.help = {
  name: "warnlevel",
  description: "give the amount of warns of someone !warnlevel @name",
  administrator: false,
